          ...
          <div className="w-full flex border-b">
            <form className="w-full" onSubmit={paymentHandler}>
              <div className="w-full flex pb-3">
                <div className="w-[50%]">
                  <label className="block pb-2">الاسم على البطاقة</label>
                  <input
                    required
                ...
                <div className="w-[50%]">
                  <label className="block pb-2">تاريخ الانتهاء</label>
                  <CardExpiryElement
              ...
              <div className="w-full flex pb-3">
                <div className="w-[50%]">
                  <label className="block pb-2">رقم البطاقة</label>
                  <CardNumberElement
